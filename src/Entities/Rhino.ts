...
export class Rhino extends Entity {
    ...
    /**
     * Initialize the rhino, get the animations setup and play the starting animation which will be based upon the
     * starting state.
     */
    ...
    /**
     * Set the state and then play a new current animation based upon that state.
     */
